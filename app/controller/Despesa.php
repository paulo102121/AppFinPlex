    ...
    class Despesa extends Controller
    {
        public function index()
        {
            ...
            try{
                ...
                $sql = "SELECT d.id, d.valor, d.descricao, d.desp_data ,c.nome as categoria FROM despesas as d INNER JOIN categorias as c ON d.id_categoria = c.id WHERE d.id_usuario =".Usuario::get('id')." AND MONTH(d.desp_data) = MONTH(CURRENT_DATE()) AND YEAR(d.desp_data) = YEAR(CURRENT_DATE())";
