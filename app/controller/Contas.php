<?php 
    ...
    use app\utils\Crypt_Random;
    use app\utils\{FlashMessage,Validacao,FiltraMoeda};
    use app\model\{Transaction,Repository,Criteria,Configs};
...
class Contas extends Controller
    {
        public function index()
        {
            Usuario::is_logado();
            /*
            $cri = new Crypt_Random('1234567', 'salt');
            $ps = $cri->key_to_be_crypted();
         // echo $ps; //hqDoP2yVfbInv/n3A+a7n9ExjStycphvEYumz1mxKPLQun/lH/GseiCSaQ4i34J/E4UH3S3s80Ps/GBOhqRMvg==
echo $cri->key_to_be_decrypted("hqDoP2yVfbInv/n3A+a7n9ExjStycphvEYumz1mxKPLQun/lH/GseiCSaQ4i34J/E4UH3S3s80Ps/GBOhqRMvg==");
*/
            try {
                Transaction::open('db');
            ...
            $this->view([
                ...
                'nomesistema'  => Configs::open('system_name')
            ]);            
        }
